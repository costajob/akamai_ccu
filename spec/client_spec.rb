...
describe AkamaiCCU::Client do
  ...
  it "must execute request method on POST" do
    ...
    res.body.must_equal "method=Stubs::HTTP::Post;uri=https://akaa-baseurl-xxx-xxx.luna.akamaiapis.net/;initheader={\"Content-Type\"=>\"application/json\"};body=\"{\\\"hostname\\\":\\\"bc.akamaiapibootcamp.com\\\",\\\"objects\\\":[\\\"/index.html\\\",\\\"/homepage.html\\\"]}\""
  end
end
