...
describe AkamaiCCU::Invalidator do
  it "must call the client with the specified body and auth header" do
    invalidator = AkamaiCCU::Invalidator.new(secret: Stubs.secret, client_klass: Stubs::Client, req_klass: Stubs::Decorator)
    res = invalidator.call(host: "bc.akamaiapibootcamp.com", objects: %w[/index.html /homepage.html])
